...
public class AgenciaBancaria {
    ...
    public static void criarConta() {
        ...
        PessoaFisica cliente = new PessoaFisica(Email, CPF, Nome, NmrCelular, Idade);

        System.out.println("Qual tipo de conta você gostaria de criar?");
        ...
        switch (tipoConta) {
            ...
            case 2:
                ...
                break;
            case 3:
                conta = new ContaEspecial(cliente, 1000.0); // exemplo de valor para cheque especial
                break;
            case 4:
                System.out.println("\nCNPJ: ");
                String CNPJ = input.next();
                PessoaJuridica clienteJuridico = new PessoaJuridica(Email, CNPJ, Nome, NmrCelular, Idade);
                conta = new ContaEmpresarial(clienteJuridico, 2000.0); // exemplo de valor para cheque especial
                break;
            default:
